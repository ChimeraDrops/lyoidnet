...
window.removeEmail = function(email) {
    ...
    `).join('');
    console.log('Rendered', teamEmails.length, 'emailss = teamEmails.filter(e => e !== email);
    renderEmails();
};
...
document.getElementById('create-project-form').addEventListener('submit', async (e) => {
    ...
    conCheck if Firebase is initialized
    ...
    // st title = document.getElementById('project-title').value.trim();
...
renderTodos();
renderEmails();
console.log('Initialization complete - addTodo and addEmail functions should be available'lert(`Error creating project: ${error.message}`, 'error');
